...
const ProductSummary = ({ inStock = true }) => {
            ...
            <div>
                ...
                {styles.length > 0 &&
                  ...
                  Date.now() <
                    ...
                    <>
                      ...
                      <span>
                        {formatMoney(styles[option].fields.reducedPrice)}
                      </span>
                    </>
                  ) : (
              ...
              {styles.length > 0 && (
                <>
                  ...
                  >
                    <$.Button className="OPEN_CART_SIDEBAR">
                      ADD TO CART
                    </$.Button>
                  </AddToCart>
                ...
                <li>
                  <LinksAccordion name="Features" type="features">
                    <ul>
                      ...
                      <li>
                        Comfort is important to us. All bag straps are contoured
                        for ideal support based on how you carry the pack.
                      </li>
                    </ul>
                  </LinksAccordion>
                </li>
                <li>
                  <LinksAccordion name="Guarantee" type="features">
                    <p>
                      ...
                      believe deeply in our process. We offer a lifetime
                      guarantee on all of our bags.
                    </p>
                  </LinksAccordion>
                </li>
              </$.List>
            ...
            <ul>
              <li>
                <LinksAccordion type="faq" name="Shipping">
                  ...
                  <p>
                    We offer free shipping in the lower 48 states and offer
                    shipping options for all other locations.
                  </p>
                  <p>
              ...
              <li>
                <LinksAccordion type="faq" name="Orders">
                  ...
                  <p>
                    Sorry, but we do not offer any gifting services at this
                    time.
                  </p>
                  <p>
                  ...
                  <p>
                    We are sorry for the inconvenience! Contact our support team
                    so we can file the details and make it right for you.
                  </p>
                </LinksAccordion>
              </li>
              <li>
                <LinksAccordion type="faq" name="Product Care">
                  ...
                  <p>
                    You can wash it on a gentle cycle and then hang it to dry.
                  </p>
                </LinksAccordion>
              </li>
            </ul>
          ...
          <$.QualityStatement>
            ...
            <div>
              ...
              <p>
                ...
                because that is how we do it. All of our products are hand made
                in the USA and produced with the finest materials and
                craftsmanship. In an age of mass produced products and throw
                away culture we take a step back in time, to when handcrafted,
                quality items were the rage.
              </p>
            </div>
          </$.QualityStatement>
        </>
