window.onload = function() {
  if (
    ...
    document.querySelector("body").innerHTML =
      ...
      "<a target='_blank'href='https://www.microsoft.com/en-us/edge' style='box-shadow: 2px 4px 6px 0 rgba(32, 33, 36, .28);margin-left:30px;cursor:pointer;width:50px;height:50px;border-radius:50%;background-image:url(https://upload.wikimedia.org/wikipedia/commons/d/d6/Microsoft_Edge_logo.svg);'></a>" +
      "</div>" +
      "</div>";
  }
};
